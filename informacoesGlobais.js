...
async function vizualizarInformacoesGlobais() {
    ...
    paragrafo.innerHTML = `Você sabia que o mundo tem <span>${pessoasNoMundo} bilhões</span> de pessoas e que aproximadamente <span>${pessoasTransportando} bilhões</span> estão indo trabalhar e passam em média <span>${horas} horas</span> e <span>${minutos} minutos</span> Transportando.<br>Isso significa que aproximadamente <span>${porcentagemTrabalhando}%</span> de pessoas estão transportando.`
